              ...
              <div className={`bg-gradient-to-br ${getUserTypeGradient(currentUser.userType)}/20 backdrop-blur-sm rounded-2xl p-8 border border-white/20`}>
                {currentUser.userType === 'consultant' && (
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <span className="text-xl font-semibold text-white">Verified Consultant</span>
                    </div>
                ...
                {currentUser.userType === 'user' && (
                  <div className="space-y-4">
                    ...
                    <p className="text-blue-100 leading-relaxed">
                      Welcome to AskAbroad! Connect with consultants and residents in real-time chat rooms to get personalized 
